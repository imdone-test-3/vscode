...
export default class MergeDectorator implements vscode.Disposable {
	...
	dispose() {
		...
		// TODO: Replace with Map<string, T> id:9 gh:10
	...
	private async applyDecorations(editor: vscode.TextEditor) {
		...
		try {
			...
			conflicts.forEach(conflict => {
				// TODO , this could be more effective, just call getMatchPositions once with a map of decoration to position id:10 gh:11
